...
class QuestionMethodTests(TestCase):
	...
	def test_was_published_recently_with_recent_question(self):
		"""
		was_published_recently() should retrun true for 
		question whose pub_date is within the last day.
		"""

		time = timezone.now() - datetime.timedelta(hours=1)
		recent_qusetion = Question(pub_date=time)
		self.assertEqual(recent_qusetion.was_published_recently(), True)
...
class QuetionViewTests(TestCase):
...
class QuestionIndexDetailTests(TestCase):
	...
	def test_detail_view_with_a_future_question(self):
		"""
		The deatil view of a question with a pub_ate
	...
	def test_detail_view_with_a_past_question(self):
		"""
		The deatil view of a question with a pub_date
